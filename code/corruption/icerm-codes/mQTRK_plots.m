function mQTRK_plots(tdims, num_corrupt_array, k_array, q_array, num_trials, num_its, cor_size)

%% Code to generate QTRK plots %%

% Create a new folder to the save figure
rnumb = num2str(floor(1000 * rand));
folderName = ['mExp_',num2str(rnumb)] ;
...
for i = 1:param1
    for j = 1:param2
        for l = 1:param3
            ...
            % Run QTRK
            errs_matrix = mQTRK_trials(tdims, num_corrupt, q, k, cor_size, num_trials, num_its);
